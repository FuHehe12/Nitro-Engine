...
6. **Tone sample**: `[tone sample segment path]` — a representative already-translated segment from this document; your translation must match its style
...
1. **Read all reference files**: glossary, translation brief, translation samples, tone sample
...
- [ ] Does the style match the tone sample?
